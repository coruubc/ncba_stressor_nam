...
Examine the results of the ocean health index cummulative human impacts from Halpern et al 2019. The data used for the analysis was downloaded from the  [KNB repo. here](https://knb.ecoinformatics.org/view/doi:10.5063/F12B8WBS) and the code on the [OHI repository](https://github.com/OHI-Science/impact_acceleration). 


Reference paper for this analysis:
Halpern, B. S., Frazier, M., Afflerbach, J., Lowndes, J. S., Micheli, F., Hara, C. O., Scarborough, C. and Selkoe, K. A., 2019. Recent pace of change in human impact on the world’s ocean. Scientific Reports [online], 1–8. Available from: http://dx.doi.org/10.1038/s41598-019-47201-9.
...
Note that the original code for this (below) can be found on [GitHub](https://github.com/OHI-Science/impact_acceleration/blob/f4e2fdb456f87869d8bf7c0f2b45bfb46bad425e/paper/Figures.Rmd#L492)
